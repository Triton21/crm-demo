...
class UserController extends Controller {
    ...
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            $checkBoxSuper = $form->get('isSuperAdmin')->getData();
            //var_dump($checkBoxSuper);die;
            if ($checkBoxSuper == true) {
                $role = 'ROLE_MAKE_ADMINS';
            } else {
    ...
    public function editAction(Request $request, $id) {
        ...
        if (in_array('ROLE_MAKE_ADMINS', $entity->getRoles())) {
            $request->getSession()
                    ->getFlashbag()
    ...
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            $checkBoxSuper = $editForm->get('isSuperAdmin')->getData();
            if ($checkBoxSuper == true) {
                $role = 'ROLE_MAKE_ADMINS';
            } else {
